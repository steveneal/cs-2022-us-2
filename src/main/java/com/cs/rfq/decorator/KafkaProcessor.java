...
public class KafkaProcessor {
    ...
    private static final String RFQ_STREAM_ID = "rfq_stream_group_id";
    private static final String TOPIC_NAME = "rfq";
    private final JavaStreamingContext streamingContext;
    private final SparkSession session;

    public KafkaProcessor(SparkSession session, JavaStreamingContext streamingContext){
    ...
    JavaDStream<String> initRfqStream(){
        ...
        kafkaParams.put(ConsumerConfig.GROUP_ID_CONFIG, RFQ_STREAM_ID);
